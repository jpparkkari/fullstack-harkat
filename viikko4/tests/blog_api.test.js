...
beforeEach(async () => {
  logger.info('initializing blogs')
...
describe('Blog additions and deletions', () => {
...
describe('Erroneus requests', () => {
  ...
  test('creating user with too short username or password is not allowed', async () => {
    const user = {
      username: 'nn',
      password: 'pw'
    }
